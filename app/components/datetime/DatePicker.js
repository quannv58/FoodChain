...
class DatePicker extends Component {
  ...
  getDate(date = this.props.date, dateHolder = this.props.placeHolderDatePicker) {
    ...
    if (!date) {
      ...
      //
      // return now;
      if (dateHolder instanceof Date) {
        return dateHolder;
      }

      return Moment(dateHolder, format).toDate();
    }
  ...
  getTitleElement() {
    ...
    return (<Text style={[Style.dateText, customStyles.dateText, disabled && {color: 'rgb(120,131,140)'}]}>{this.getDateStr()}</Text>);
  }
      ...
      >
        <View style={{flex: 1}}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Text style={[Style.btnTextText, Style.btnTextConfirm]}>{confirmBtnText}</Text>
                      </TouchableComponent>
                    </Animated.View>
                  </TouchableComponent>
                </TouchableComponent>
          ...
          <View
            style={{
              height: 1,
              backgroundColor: 'rgb(182,190,197)',
            }}
          />
        </View>
